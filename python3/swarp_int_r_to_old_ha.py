...
def swarp_resample(infile, reffile, outname, weightfile=None, outweight=None, overwrite=False):
    ...
    cmd = [
        ...
        "-SUBTRACT_BACK", "N",
        "-FSCALE_DEFAULT", "1.0",
        "-COPY_KEYWORDS", "OBJECT,FILTER,INSTRMNT,TELESCOP,GAIN,EPOCH,DATE-OBS,MJD-OBS,AIRMASS,EXPTIME,PHOTZP,MAGZP,PAN_FZP,FLTRATIO,FILTER_RATIO,FSCALE,SKYMED,SKYSTD,BUNIT,GAIN,RDNOISE,RIMAGE,HAIMAGE,SEFWHM,FWHM",
        ]
