...
R-band image cutouts with a prefix that matches the input string.  
...
parser.add_argument('--pointing', dest = 'string', default = None, help = 'image string to match (e.g. A1367)')
